...
if(!$trains || !$stations) {
    $trains = fetchHttp("https://guangdong-intercity-data.bobliu.tech/{$date}/trains.json");
    $stations = fetchHttp("https://guangdong-intercity-data.bobliu.tech/{$date}/stations.json");
